<template>
  <ElDialog v-model="dialogVisible" width="30%">
    <div class="md:px-8 text-black font-400">
      ...
      <div class="mb-3.75"> 请向此下面的地址转账 <strong class="text-pruple text-7.5">19.01 USDT</strong></div>
      <div class="mb-3.75 font-900 break-all">0x54545as1d5asd54a5s1d <span class="underline cursor-pointer"
          @click="onCopy">复制</span>
      </div>
      <div class="mb-3.75">请确保你发送的金额是<strong class="text-pruple">19.01 USDT</strong>, 否则将无法开通成功。 </div>
